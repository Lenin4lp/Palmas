  ...
  return (
    <div className=" flex overflow-hidden relative">
      <div className=" block md:flex">
        <div
          className={` bg-gradient-to-b from-[#852655] to-[#8f0e2a] w-screen md:w-[70px]  pt-5  sm:pt-8 duration-300 h-[90px] md:h-screen flex justify-center items-center sticky bottom-0 md:top-0 z-10`}
        >
          ...
          <div className=" flex md:grid grid-rows-1 gap-4 sm:gap-8 md:gap-4 lg:gap-5">
            <div>
              <svg
