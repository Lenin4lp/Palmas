          ...
          <div className=" flex-wrap my-5 flex justify-center">
            {aliquots.length > 0 &&
              aliquots.map((aliquot) => (
                <div className=" h-[110px] md:h-[120px] w-[200px] md:w-[220px] rounded-lg relative bg-[#8f0e2a] hover:bg-[#852655] flex justify-center items-center transition duration-300  ">
                  ...
                  {selectedPlace.pending_value > 0 && (
                    <div className=" my-5 flex justify-center items-center">
                      <div className=" w-full md:w-fit block md:min-w-[700px] rounded-md bg-white min-h-[350px]">
                        ...
                        {selectedPay === "" && (
                          <div className=" my-20 block md:flex justify-center items-center">
                            <h1 className=" text-lg font-bold text-[#8f0e2a]">
