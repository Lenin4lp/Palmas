  ...
  return (
    <ContentComponent>
      <div className=" m-5 block">
        ...
        <div className=" relative mt-10 mb-5 flex justify-center sm:justify-end rounded-lg bg-white ">
        ...
        <div className=" flex justify-center items-center">
          <div className="  mt-5 h-[350px] md:h-[500px] overflow-x-auto overflow-y-auto w-[280px] sm:w-[600px] md:w-[680px]  lg:w-full  ">
              ...
              <tbody>
                {search === ""
                  ...
                  : neighborsTable.map((neighbor) => (
                      <tr key={neighbor.neighbor_id} className=" text-[12px]">
                        <th className=" border  border-slate-300  py-2">
                          {neighbor.neighbor_id}
                        </th>
                        <th className=" text-left border border-slate-300 px-3 py-2">
