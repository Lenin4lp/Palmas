...
function VehicleTypes() {
  ...
  const removeType = async (id) => {
    try {
      ...
      if (res.status === 204) {
        toast.success("Tipo de vehículo eliminado con éxito");
        setTimeout(() => {
          window.location.href = `/inmuebles/config/tipos_de_vehiculo`;
        }, 2000);
      }
  ...
  const selectedVehicleType =
    selectedType != "" &&
    types.find((type) => type.vehicleType_id == selectedType);
    ...
    <ContentComponent>
      <div className=" flex min-h-fit justify-center items-center bg-gradient-to-br from-[#852655] to-[#8f0e2a] w-screen">
        <Modal open={open} onClose={() => setOpen(false)}>
          {(selectedType != "" && selectedVehicleType.vehicleType_id == 1) ||
          selectedVehicleType.vehicleType_id == 2 ? (
            selectedVehicleType.vehicles.length > 0 ? (
              <div className=" block m-3">
                ...
                <div className=" pt-5 flex justify-center items-center">
                  <h1 className=" text-white">
                    Primero se deben eliminar todos vehículos de este tipo.
                  </h1>
                </div>
              ...
              <div className=" block m-3">
                ...
                <div className=" pt-5 flex justify-center items-center">
                  <h1 className=" text-white">
                    No se pueden eliminar los tipos por defecto
                  </h1>
                </div>
              </div>
            )
            ...
            <div className=" block m-3">
              ...
              <div className=" my-3">
                <h1 className=" text-center text-white text-base font-medium">
                  ¿Estás seguro de eliminar el tipo de vehículo?
                </h1>
              </div>
              <div className=" flex justify-center items-center">
                <div className=" my-2 grid grid-cols-2">
                  <div className=" mx-4">
                    <button
                      onClick={() =>
                        removeType(selectedVehicleType.vehicleType_id)
                      }
        ...
        <Modal open={open2} onClose={() => setOpen2(false)}>
          <div className=" block m-3">
            ...
            <div className=" my-3">
              <h1 className=" text-center text-white text-base font-medium">
                ¿Estás seguro de registrar el tipo de vehículo?
              </h1>
            </div>
            <div className=" flex justify-center items-center">
              <div className=" my-2 grid grid-cols-2">
                              ...
                              >
                                ...
                                <th className=" border  h-full border-slate-300  py-2">
                                  <div className=" flex justify-center items-center">
                                    <svg
                                      onClick={() => {
                                        setSelectedType(type.vehicleType_id);
                                        setOpen(true);
                                      }}
                                      viewBox="-3 0 32 32"
                                      version="1.1"
